...
class TestCreateCourier:
    ...
    def test_create_courier_with_valid_data_success(self,delete_courier):
        with allure.step('Создать курьера через метод регистрации'):
            courier = register_new_courier_and_return_login_password()

        with allure.step('Проверить, что данные курьера не пустые'):
    ...
    def test_create_two_couriers_with_the_same_data_fails(self,delete_courier):
    ...
    def test_create_courier_with_only_required_fields_success(self,delete_courier):
    ...
    def test_create_courier_without_required_field_fails(self, missing_field, delete_courier):
    ...
    def test_create_courier_with_existing_login_fails(self, created_courier):
